...
class Visual(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button2 = ttk.Button(self, text = "Start",
                              command = lambda: [self.setstop(False),self.startCodeThread()], image = "")
        button2.place(x = 800, y = 760, width = 200, height = 80)
        
        button3 = ttk.Button(self, text = "Stop",
                              command = [self.setstop(True),print('presiono stop'),self.startCodeThread()], image = "")
        button3.place(x = 1100, y = 760, width = 200, height = 80)
